...
For 32-bit storage, the exponent is at most 7 and the mantissa has 23 digits.  Note that 0 does not belong to $\mathcal{F}$ since it cannot be represented in the form shown in @eq-float and it is therefore handled separately.
